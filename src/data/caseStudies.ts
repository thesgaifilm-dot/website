...
export const caseStudies: CaseStudy[] = [
  {
    ...
    problem:
      'A fast-growing Wuhan AI company had advanced social-media analytics technology but no legal presence, governance model or compliance framework to commercialise it in Southeast Asia, and it faced severe penalties under Chinese data-export law if it got cross-border data flows wrong.',
    solution:
