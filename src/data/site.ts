export const site = {
  ...
  phone: '+65 8782 4594',
  phoneHref: 'tel:+6587824594',
  whatsapp: 'https://wa.me/6587824594',
  infoAsOf: 'July 2026',
}
...
export const serviceSummaries = [
  {
    id: 'overseas',
    title: 'Overseas Development Consultation',
    blurb:
      'Market entry strategy, cross-border structuring, regulatory compliance and in-market execution across China, Malaysia and seven more Asian markets.',
    icon: 'globe',
  },
  {
    id: 'hr',
  ...
  },
  {
    ...
    title: 'AI Solutions',
    blurb:
      'Close to 100 developers across four countries design, plan, build and implement AI tools that cut costs and grow revenue.',
    icon: 'ai',
  },
  {
    id: 'digital',
    ...
    blurb:
      'Software implementation, workflow re-engineering, brand positioning and performance marketing that converts.',
    icon: 'chart',
  },
]

export const footprint = {
  ownOffices: ['Singapore (HQ)', 'China', 'Malaysia'],
  partnerMarkets: ['Taiwan', 'Japan', 'Korea', 'Vietnam', 'Thailand', 'Laos', 'Cambodia'],
}
