    ...
    <>
      <section className="bg-ink-900">
        <div className="mx-auto max-w-6xl px-4 py-20 sm:px-6">
          <p className="text-sm font-bold uppercase tracking-[0.25em] text-coral-400">Services</p>
          <h1 className="mt-3 max-w-3xl text-4xl font-extrabold tracking-tight text-white sm:text-5xl">
            Strategy, people and technology — under one roof
          </h1>
          <p className="mt-5 max-w-2xl text-lg text-ink-200">
            Most consultancies stop at the report. We design the strategy, assemble the teams and
            execute it on the ground with our own people across Asia.
          </p>
        </div>
      </section>
      ...
      <section id="overseas" className="scroll-mt-24">
        <div className="mx-auto max-w-6xl px-4 py-20 sm:px-6">
          <SectionHeading
            ...
            body="We maintain our own staffed offices in China and Malaysia and live working partners across seven more Asian markets. Incorporation, licensing, market representative agreements and regulatory filings are handled by our people — not passed to strangers."
          />
          <div className="mt-10 grid gap-6 lg:grid-cols-3">
            {[
              ...
              <div key={x.t} className="rounded-2xl border border-ink-100 p-7">
      ...
      <section id="hr" className="scroll-mt-24 bg-ink-50">
        <div className="mx-auto grid max-w-6xl items-start gap-12 px-4 py-20 sm:px-6 lg:grid-cols-2">
          <SectionHeading
            ...
            body="Our founder has built teams of 40, 60 and 80 people in four to six months — repeatedly, across industries. We bring that playbook to your organisation: recruitment engines, structured onboarding, workforce development and retention strategies that hold up under rapid growth."
          />
          <div className="grid gap-4 sm:grid-cols-2">
            {[
              ...
              <div key={x.t} className="rounded-2xl bg-white p-6 shadow-sm">
        ...
        <div className="mx-auto grid max-w-6xl items-start gap-12 px-4 py-20 sm:px-6 lg:grid-cols-2">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {[
              ...
              <div key={x.t} className="rounded-2xl border border-ink-100 p-6">
                <span className="text-sm font-bold text-coral-500">0{i + 1}</span>
                <h3 className="mt-1 font-bold text-ink-900">{x.t}</h3>
                <p className="mt-2 text-sm leading-relaxed text-ink-600">{x.d}</p>
              </div>
        ...
        <div className="mx-auto max-w-6xl px-4 py-20 sm:px-6">
          ...
          <div className="mt-10 grid gap-6 sm:grid-cols-2">
            {[
              ...
              <div key={x.t} className="rounded-2xl bg-white p-7 shadow-sm">
                <h3 className="font-bold text-ink-900">{x.t}</h3>
                <p className="mt-2 text-sm leading-relaxed text-ink-600">{x.d}</p>
              </div>
            ))}
